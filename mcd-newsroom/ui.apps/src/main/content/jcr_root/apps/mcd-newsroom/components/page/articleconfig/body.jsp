...
<%
    ...
    String templatePath = "/apps/mcd-newsroom/templates/articletemplate";
    ...
    if(parentPage !=null){
         Calendar today = Calendar.getInstance();
            ...
            Page yearPage = pageManager.getPage(contentPath+"/"+year);
            if(yearPage == null){
                yearPage =pageManager.create(contentPath,year,"/apps/",year);
            }
    ...
    CQ.Ext.onReady(function() {
        ...
        myForm.addButton({
            ...
            handler: function() {
                ...
                frm.url=parentPath+'/';
                frm.url=frm.url.substring(0,(frm.url.length))+year+'/'+month+'/*';
