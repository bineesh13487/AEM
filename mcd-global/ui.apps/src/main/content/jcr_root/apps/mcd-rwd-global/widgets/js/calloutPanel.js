...
CQ.CalloutPanel = CQ.Ext.extend(CQ.Ext.Panel, {
    ...
    initComponent : function() {
        ...
        var formPanel = {
            ...
            items : [imagePanel, linkPanel, textPanel, positionPanel, colorPanel, altTextPanel, startTimePanel, endTimePanel, submitButtonPanel] 
        };
    ...
    onRender : function() {
        ...
        var panelFields = [ "image","alttext","overlay","position","color","link","startTime","endTime"];
        ...
        if (parentDialog) {
            ...
            parentDialog.on("beforesubmit", function() {
                ...
                var fieldNames = [ "calloutImages","altTexts", "overlayTexts", "overlayPosition", "overlayColor", "links", "startTime", "endTime"];
