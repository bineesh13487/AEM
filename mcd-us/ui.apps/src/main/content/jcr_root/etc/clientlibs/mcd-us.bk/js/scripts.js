...
*/
    ...
    function initAccessibilityModules(){
      ...
      //var modalsGroup = $('ul[data-toggle="Companies"]');
      ...
      $('.modal').on('shown.bs.modal', function (e) {
        setTimeout(function(){
          if($('.modal-dialog .modal-focus-first').length){
            ...
            var tabbableItems = $('.modal-dialog').find(":tabbable");
            var $firsttabbableElmt = $(tabbableItems[0]);
            $firsttabbableElmt.focus();
          }
        ...
        /*$('.modal-dialog .last-elmt').focus(function(e){
          var tabbableElms = $('.modal-dialog').find(":tabbable");
          var $firsttabbableElmt = $(tabbableElms[0]);
      ...
      $('.select').on('shown.bs.select', function (e) {
    	  ...
    	  $(this).find(".dropdown-menu li:last-child a").keydown(function(e) {
    		  if(e.keyCode == 9 || e.keyCode == 39){
    			  ally.element.focus(firstElm);
    			  setTimeout(function(){ ally.element.focus(firstElm); }, 10);
    		  }
    	  });
      });
...
var videosList = {
    ...
    createSliderButtons : function (sliderContainer){
        ...
        htmlContent +=  '<button type="button" class="flex-play paused" aria-label="Pause slider"><i class="fa fa-play-circle fa-lg"></i></button>';
        htmlContent += '</li>';
