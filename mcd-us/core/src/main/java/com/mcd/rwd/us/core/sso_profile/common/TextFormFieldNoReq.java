...
@Component(
        value = "Text Form Field No Req",
        path = SSOProfileConstants.SSO_COMPONENTS_PATH + "/common",
        disableTargeting = true,
        editConfig = false,
        group = ComponentConstants.GROUP_HIDDEN)
@Model(adaptables = { Resource.class, SlingHttpServletRequest.class })
public class TextFormFieldNoReq extends TextFormFieldBase {
...
//            defaultValue = SSOProfileConstants.RESOURCE_TEXT_FORM_FIELD_NO_REQ_COMPONENT)
//    @Hidden(value = SSOProfileConstants.RESOURCE_TEXT_FORM_FIELD_NO_REQ_COMPONENT)
